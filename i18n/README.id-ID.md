...
🎉 Dashboard terbuka di `http://localhost:32060`
...
- API kompatibel OpenAI: `http://localhost:32060/v1`
...
docker run -d \
  ...
  -e PORT=32060 \
  -e BASE_URL=http://localhost:32060 \
...
```bash
npm install -g 9router
PORT=32060 HOSTNAME=0.0.0.0 BASE_URL=https://your-domain.com 9router
```
...
|---------|----------------------|--------|
| Tool CLI tidak bisa konek | Endpoint salah | Pastikan `http://localhost:32060/v1` |
