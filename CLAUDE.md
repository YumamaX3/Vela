...
cp .env.example .env
npm install
PORT=32060 NEXT_PUBLIC_BASE_URL=http://localhost:32060 npm run dev   # dev (webpack, port 20127 by default via next dev)
npm run build && PORT=32060 HOSTNAME=0.0.0.0 npm run start           # production
```
