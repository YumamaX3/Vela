 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Vela needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a Vela
 ...
 * The suffix is a Vela request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a Vela synthetic agentic variant.
...
/**
 * Detect whether a model id is a Vela synthetic thinking variant
...
/**
 * Resolve a Vela model id to the real upstream Kiro model id, plus flags
