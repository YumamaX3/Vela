...
export function filterToOpenAIFormat(body, opts = {}) {
  ...
  body.messages = body.messages.map(msg => {
    ...
    if (Array.isArray(msg.content)) {
      ...
      // The same contract the translators hold: a text-only array flattens to a
      // string (some OpenAI-compatible providers reject array content), while a
      // multimodal array is preserved as-is.
