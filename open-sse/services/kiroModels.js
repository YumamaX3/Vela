 ...
 * API. They are Vela fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic Vela variant set for a single upstream Kiro model.
 *
 ...
 * into Vela variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
