// Model-name context markers — Claude Code appends a bracketed context marker
// to the model name when the 1M-context beta is toggled on: `claude-opus-5`
// becomes `claude-opus-5[1m]`. The marker is a client-side annotation, not
// part of any model id: it never matches a combo name, an alias or a
// `provider/model` pair, so a request that carries it dies at model resolution
...
// (Ported from upstream 9router ee7a9616 — W2, v0.9.48.)
