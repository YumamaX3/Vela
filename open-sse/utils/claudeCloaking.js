 ...
 * without this the client receives the cloaked (CLAUDE_TOOL_SUFFIX-suffixed)
 * tool name and rejects the call as an unknown tool. In a Claude SSE stream a
 * tool name appears exactly once per call — on the content_block_start event of
