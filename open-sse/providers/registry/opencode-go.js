export default {
  ...
  models: [
    ...
    // Responses-only models are served by /zen/go/v1/responses alone — a
    // chat/completions call answers 500 upstream (#3819/#3820). The entry forces
    // chatCore past the sourceFormat-matched transports into translation (see the
    // chatCore guard), so the body and the endpoint can never disagree.
