...
export default function ChangelogModal({ isOpen, onClose }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ref={modalRef}
        className="relative w-full bg-surface border border-black/10 dark:border-white/10 rounded-xl shadow-2xl motion-enter max-w-3xl flex flex-col max-h-[85vh]"
      >
        {/* Header */}
