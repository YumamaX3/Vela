    ...
    <Card>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <select
          ...
          disabled={saving}
          className="py-2 px-3 text-sm text-text-main bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-md focus:ring-1 focus:ring-primary/30 focus:border-primary/50 focus:outline-none motion-control disabled:opacity-50"
        >
          {STRATEGIES.map((s) => (
