// Shared /v1/models list builder — extracted from src/app/api/v1/models/route.js
// so both the LLM route (route.js) and the capability-kind route
// ([kind]/route.js) can use it WITHOUT exporting a non-route helper from a
// route module (Next.js typed route contracts reject that: TS2344).
