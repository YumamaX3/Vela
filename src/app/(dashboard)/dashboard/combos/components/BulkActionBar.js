...
export default function BulkActionBar({
  ...
  return (
    <div className="pointer-events-none sticky bottom-3 z-30 flex justify-center motion-safe:transition-all">
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-border-subtle pt-2">
            ...
            {STRATEGY_OPTIONS.map((option) => (
              <button
                ...
                disabled={busy}
                className="rounded-md border border-border-subtle px-2 py-1 text-[11px] font-medium transition-colors hover:border-primary/40 hover:text-primary"
              >
                {option.label}
              </button>
            ))}
            <button
              ...
              disabled={busy}
              className="rounded-md border border-border-subtle px-2 py-1 text-[11px] text-text-muted transition-colors hover:text-text-main"
        ...
        {panel === "rename" && (
          ...
          >
            ...
            <button
              ...
              className={cn(
                "rounded-md border border-border-subtle px-2 py-1 text-[11px] font-medium transition-colors hover:border-primary/40 hover:text-primary",
