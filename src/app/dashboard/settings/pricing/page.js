      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={handleSync}
            disabled={syncing}
            className="px-4 py-2 border border-primary text-primary rounded hover:bg-primary/10 motion-control disabled:opacity-50"
          >
            {syncing ? "Syncing…" : "Sync Prices"}
          </button>
          <button
            onClick={() => setShowModal(true)}
            className="px-4 py-2 bg-primary text-white rounded hover:bg-primary/90 motion-control"
          >
            Edit Pricing
          </button>
        </div>
      ...
      {syncMeta && (
        <Card className="p-4 flex items-center justify-between">
          ...
          <button
            ...
            className="text-sm text-red-500 hover:bg-red-500/10 border border-red-500/20 rounded px-3 py-1.5 motion-control"
          >
            Clear Synced Prices
          </button>
        </Card>
