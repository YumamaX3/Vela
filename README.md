...
- OpenAI-compatible API: `http://localhost:32060/v1`
...
| `BASE_URL`                                           | `http://localhost:32060`                 | Server-side internal base URL used by cloud sync jobs                               |
...
- Set `PORT=32060` and `NEXT_PUBLIC_BASE_URL=http://localhost:32060`
