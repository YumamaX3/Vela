...
describe("bug: Claude → OpenAI bridge data loss", () => {
  ...
  // claude-to-openai.js:203-222 — WAS the bug: tool_result image block dropped (text only)
  // FIXED 2026-09-19 (upstream 9router v0.5.81 port): image kept, call id tagged.
