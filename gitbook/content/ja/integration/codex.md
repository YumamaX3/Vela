...
VelaをOpenAI Codex CLIと統合し、OpenAI APIリクエストをVelaのインテリジェントルーティングシステム経由でルーティングします。
...
1. モデル名がVela設定と一致するか確認
2. VelaダッシュボードでOpenAIプロバイダー接続がアクティブか確認
