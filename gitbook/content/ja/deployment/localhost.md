...
開発と個人利用のため、ローカルマシンでVelaを実行。

---

## 📦 インストール

npm経由でVelaをグローバルインストール:
...
APIポート(32060)とダッシュボードポート(3000)はアプリケーションで設定されています。変更するにはソースコードを修正するか、サポートされている場合は環境変数を使用してください。

---

## 🛑 サーバーの停止

Velaが実行されているターミナルで `Ctrl+C` を押します。
