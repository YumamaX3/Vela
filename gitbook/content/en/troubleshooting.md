...
Common issues and solutions when using Vela.
...
1. **Auto-refresh (default):**
   Vela automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:32060".
