...
Triển khai Vela trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
Tạo `/etc/nginx/sites-available/Vela`:
...
# If NOT using reverse proxy, allow Vela ports
