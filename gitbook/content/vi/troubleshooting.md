...
Các vấn đề và giải pháp phổ biến khi dùng Vela.
...
1. **Auto-refresh (mặc định):**
   Vela tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Vấn đề:** Lỗi "ECONNREFUSED" hoặc "Cannot connect to localhost:32060".
