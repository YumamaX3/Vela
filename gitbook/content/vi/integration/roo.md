...
Tích hợp Vela với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
### Connection Failed
- Xác minh Vela đang chạy: `curl http://localhost:32060/health`
