...
Tích hợp Vela với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.
...
- Kiểm tra Vela đang chạy: `curl http://localhost:32060/health`
...
- Kiểm tra độ trễ network đến Vela
