...
Integra Vela con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Vela.
...
```bash
# Base URL for Vela
export OPENAI_BASE_URL="http://localhost:32060/v1"

# API Key from Vela dashboard
export OPENAI_API_KEY="your-Vela-api-key"
```
...
Vela proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de Vela
...
1. Verifica que el nombre del modelo coincida con tu configuración de Vela
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Vela
