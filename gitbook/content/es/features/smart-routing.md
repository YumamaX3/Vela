...
Vela enruta automáticamente tus solicitudes a través del mejor proveedor disponible usando un sistema de fallback de 3 niveles. Nunca dejes de codificar debido a límites de cuota o rate-limiting.

---

## Cómo funciona

Vela usa enrutamiento inteligente para maximizar tus suscripciones existentes, minimizar costos y garantizar disponibilidad 24/7:

```
Solicitud → Vela → Verificar Nivel 1 (Suscripción)
                       ↓ cuota agotada
...
Vela monitorea la cuota en tiempo real y cambia de proveedor automáticamente:
...
Vela selecciona el mejor modelo según:
...
Cuando se alcanza el presupuesto, Vela cambia automáticamente al nivel gratis.
